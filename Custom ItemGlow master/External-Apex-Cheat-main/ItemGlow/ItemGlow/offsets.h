...
#define OFFSET_IN_ATTACK 0x040c1cf0   //in_attack
#define OFFSET_IN_JUMP 0x040c1d88	//in_jump
#define OFFSET_IN_RELOAD 0x040c1d30 //in_reload

#define OFFSET_GLOBALVARS 0x128bf40  //GlobalVars
